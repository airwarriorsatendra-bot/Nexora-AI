...
ENV_GMAIL_CLIENT_ID: str = "GMAIL_CLIENT_ID"
ENV_GMAIL_CLIENT_SECRET: str = "GMAIL_CLIENT_SECRET"
ENV_GMAIL_REFRESH_TOKEN: str = "GMAIL_REFRESH_TOKEN"
ENV_GMAIL_SENDER_EMAIL: str = "GMAIL_SENDER_EMAIL"
ENV_GMAIL_TOKEN_URI: str = "GMAIL_TOKEN_URI"
ENV_GMAIL_LIVE_SEND_ENABLED: str = "GMAIL_LIVE_SEND_ENABLED"
