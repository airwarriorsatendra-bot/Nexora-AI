...
class ProviderClassification(str,Enum):GROUNDED_WITH_CITATIONS="GROUNDED_WITH_CITATIONS";GROUNDED_WITHOUT_STRUCTURED_CITATIONS="GROUNDED_WITHOUT_STRUCTURED_CITATIONS";UNGROUNDED_MODEL_RESPONSE="UNGROUNDED_MODEL_RESPONSE";UNAVAILABLE="UNAVAILABLE"
class ObservationState(str,Enum):SUCCESS="SUCCESS";PROVIDER_ERROR="PROVIDER_ERROR";TIMEOUT="TIMEOUT";RATE_LIMITED="RATE_LIMITED";UNAVAILABLE="UNAVAILABLE";EMPTY_RESPONSE="EMPTY_RESPONSE"
...
class Citation(NexoraModel):
 model_config=ConfigDict(frozen=True,extra="forbid");url:str;title:str="";index:int=Field(ge=1)
